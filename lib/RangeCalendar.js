...
var RangeCalendar = (0, _createReactClass2['default'])({
  ...
  propTypes: {
    ...
    accountCreatedAt: _propTypes2['default'].any,
  },
  ...
  disabledStartMonth: function disabledStartMonth(month) {
    ...
    if(this.props.accountCreatedAt && month.isBefore(this.props.accountCreatedAt, 'month')) {
      return true;
    } else {
  ...
  disabledEndMonth: function disabledEndMonth(month) {
    ...
    if(month.isAfter(new Date(), 'month')) {
      return true;
     } else {
  ...
  disabledStartYear: function disabledStartYear(year) {
    var value = this.state.value;
    if(this.props.accountCreatedAt && year.isBefore(this.props.accountCreatedAt, 'year')) {
      return true;
    } else {
