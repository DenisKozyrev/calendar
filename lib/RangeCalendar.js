...
var RangeCalendar = (0, _createReactClass2['default'])({
  ...
  propTypes: {
    ...
    periodStep:_propTypes2['default'].string,
    ...
    disabledStartMonthDate: _propTypes2['default'].any,
    disabledEndMonthDate: _propTypes2['default'].any,
    disabledStartYearDate: _propTypes2['default'].any,
    disabledEndYearDate: _propTypes2['default'].any,
  },
  ...
  onEndValueChange: function onEndValueChange(rightValue) {
    var value = [].concat(this.state.value);
    value[1] = rightValue;
    this.props.onSelect && (this.props.periodStep === 'Monthly' || this.props.periodStep === 'Yearly') ? this.props.onSelect(value) : null;
    return this.fireValueChange(value);
  ...
  disabledStartMonth: function disabledStartMonth(month) {
    ...
    if(this.props.disabledStartMonthDate && month.isBefore(this.props.disabledStartMonthDate, 'month')) {
      return true;
    } else {
  ...
  disabledEndMonth: function disabledEndMonth(month) {
    ...
    if(month.isAfter(this.props.disabledEndMonthDate, 'month')) {
      return true;
     } else {
      return month.isSameOrBefore(value[0], 'month');
     }
  },
  disabledStartYear: function disabledStartYear(year) {
    var value = this.state.value;
    if(this.props.disabledStartYearDate && year.isBefore(this.props.disabledStartYearDate, 'year')) {
      return true;
    } else {
      return year.isAfter(value[1], 'year');
    }
  },
  disabledEndYear: function disabledEndYear(year) {
    var value = this.state.value;

    if(year.isAfter(this.props.disabledEndYearDate, 'year')) {
      return true;
     } else {
      return year.isBefore(value[0], 'year');
     }
  },
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_CalendarPart2['default'], (0, _extends3['default'])({}, props, newProps, {
            ...
            disabledYear: this.disabledStartYear,
          ...
          _react2['default'].createElement(_CalendarPart2['default'], (0, _extends3['default'])({}, props, newProps, {
            ...
            disabledYear: this.disabledEndYear,
